...
curl -s "http://localhost:8082/addAmount?custId=203&amount=10000"
curl -s "http://localhost:8082/addAmount?custId=202&amount=10000"
...
rideId3=$(curl -s "http://localhost:8081/requestRide?custId=203&sourceLoc=10&destinationLoc=120")
